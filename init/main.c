...
#include "../drivers/soc/opl/system/tl_phoenix/opl_phoenix.h"
...
//#ifdef OPL_FEATURE_PHOENIX
	// Kun.Hu@PSW.TECH.RELIABILTY, 2018/11/15, add for project phoenix(hang tl)
	if(phx_set_boot_stage)
		phx_set_boot_stage(KERNEL_MM_INIT_DONE);
//#endif //OPL_FEATURE_PHOENIX
