...
static void phx_handle_hang_opl(const char *);
...
static phx_action_mapping errno_handle_action_mapping[] = {
	...
	{ ERROR_HANG_OPL, phx_handle_hang_opl },
...
static void phx_handle_hang_opl(const char *happen_time)
{
	phx_klog_booterror(ERROR_HANG_OPL, happen_time);
	phx_log_dump(ERROR_HANG_OPL);
}
