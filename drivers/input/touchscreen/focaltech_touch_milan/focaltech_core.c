...
extern int FTS_tl_proc_node_init(void);
...
static int fts_ts_probe_entry(struct fts_ts_data *ts_data)
{
	...
	ret = FTS_tl_proc_node_init();
	if (ret) {
        FTS_ERROR("init TL_proc_node_init test fail");
    }
